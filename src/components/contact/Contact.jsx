                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">@indzondzo_bila</span>
                ...
                <div className="contact__content">
                    ...
                    <form ref={form} onSubmit={sendEmail} className="contact__form">
                        ...
                        <div className="contact__form-div">
                            ...
                            <input type="email" name="email" className="contact__form-input" placeholder="carter@gmail.com"/>
                        </div>

                        <div className="contact__form-div contact__form-area">
                            <label className="contact__form-tag">Project</label>
                            <textarea type="text" name="project" cols="30" rows="10" className="contact__form-input" placeholder="Write your message..."></textarea>
                        </div>
