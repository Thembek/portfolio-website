       ...
       <section className="qualification section">
        ...
        <div className="qualification__container container">
            ...
            <div className="qualification__sections">
                <div className={toggleState === 1 ? "qualifiication__content qualificatin__content-active" : "qualifiication__content"}>
                ...
                <div className={toggleState === 2 ? "qualifiication__content qualificatin__content-active" :"qualifiication__content"}>
                    <div className="qualification__data">
                        <div>
